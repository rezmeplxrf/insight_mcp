...
export const toolDefinitions: ToolDefinition[] = [
  ...
  },
  {
    ...
    max_range: z.number().int().min(1000).max(15000).describe("Number of screener results returned per page. Values below 1000 are raised to 1000, values above 15000 are lowered to 15000.").optional(),
